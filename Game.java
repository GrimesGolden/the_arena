...
{	static Fighter player;
	...
	public static void main(String[] args) throws InterruptedException
	{
			...
			switch (move) {
				case "P": 
					...
					if (x > 10)
					{
						...
						String hitMessage = ("Computer has " + computer.getHitpoints() + " hitpoints\n");
				...
				case "W":
					...
					if (draw_weapon == 0)
					{
						String drawMessage = "You draw your " + player.getWeapon() + "! Ruthless onslaught unlocked.\n";
		...
		{
			System.out.println("||PLAYER ONE WINRAR GET||");
			System.out.println("I personally commend you");
		}
	...
	public static void init() throws InterruptedException
	{
		...
		String welcome = "Player One picked " + playerName + "\nComputer picked " + computerName;
	...
	public static void computers_turn() throws InterruptedException
	{
		int draw_weapon =1;
		Random randomNumber = new Random();
		int comps_move = randomNumber.nextInt(3);
		...
		if (comps_move == 0)
		{
			...
			if (x > 10)
			{
				...
				Thread.sleep(1000);
				String healthMessage = "Player 1 has " + player.getHitpoints() + " hit points";
			...
			else
			{
				...
				System.out.println(punchMessage);
				player.decHitpoints(x);
				String hitMessage = "Player has " + player.getHitpoints() + " hitpoints";
				System.out.println(hitMessage);
			}
		}
